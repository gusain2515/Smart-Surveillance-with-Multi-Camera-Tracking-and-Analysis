...
def run_multi_stream_object_tracking(show_video, enable_frame_skip):
    ...
    rtsp_urls = [
        "rtsp://xsens:admin12345@192.168.0.100:554/Streaming/channels/1**",
        "rtsp://xsens:admin12345@192.168.0.100:554/Streaming/channels/2**",
        "rtsp://xsens:admin12345@192.168.0.100:554/Streaming/channels/3**",
        "rtsp://xsens:admin12345@192.168.0.100:554/Streaming/channels/4**",
        "rtsp://xsens:admin12345@192.168.0.100:554/Streaming/channels/5**",
    ]
